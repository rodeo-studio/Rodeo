...
//          console.log(data);
    ...
    var self = this;
	  var strContent = '', model;
	    ...
	    strContent += '<div class="col-lg-6 col-md-6 col-sm-6 nopadding" data-id="'+model.id+'"><div class="image_container project_btn"><a href="'+model.get('link')+'"><img src="'+strImage+'" class="fade_on_load img-responsive"><div class="title inner text-giant">'+model.get('title')+'</div></a></div></div>';;
   	  });
