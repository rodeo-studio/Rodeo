  <div id="sidepanel" class="animate-move">
	  ...
	  <div id="menupanel">					  		
		  ...
		  <div class="mainmenus">
		    <div class="submenu"><span class="logo_r submenu_btn mainmenu"><img src="images/rodeo.svg"></span></div>
		    <div class="search"><span class="glyphicon glyphicon-search search_btn mainmenu"></span></div>
		    <div class="nav">
